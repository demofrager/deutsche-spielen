...
setup() {
  bash "$SCRIPT_DIR/scripts/bootstrap_toolbox.sh"
}

run_local() {
  bash "$SCRIPT_DIR/scripts/run_local_toolbox.sh"
}

test_local() {
  bash "$SCRIPT_DIR/scripts/test_local_toolbox.sh"
}
...
Commands:
  setup       Create the distrobox and install all dependencies
